...
def load_data_from_partition(data_loc: pathlib.Path, partition: str):
    assert partition in ["train", "val", "test"]

    # Construct the full paths for the X and Y tensors of the specific partition
    x_path = data_loc / f"{partition}_X.pt"
    y_path = data_loc / f"{partition}_y.pt"

    # Load only the required tensors
